...
class MobileNetV3_Large(nn.Module):
    def __init__(self):
        ...
        self.bneck2 = nn.Sequential(
            nn.Conv2d(72, 72, kernel_size=5, stride=2,
                      padding=2, groups=72, bias=False),
            nn.BatchNorm2d(72),
            nn.ReLU(inplace=True),
        ...
        self.bneck3 = nn.Sequential(
            nn.Conv2d(240, 240, kernel_size=3, stride=2,
                      padding=1, groups=240, bias=False),
            nn.BatchNorm2d(240),
            hswish(),
            ...
            nn.Conv2d(160, 672, kernel_size=1,
                      stride=1, padding=0, bias=False),
            nn.BatchNorm2d(672),
            hswish(),
        )  # 1 672 32 32
        ...
        self.bneck4 = nn.Sequential(
            nn.Conv2d(672, 672, kernel_size=5, stride=2,
                      padding=2, groups=672, bias=False),
            nn.BatchNorm2d(672),
            hswish(),
            nn.Conv2d(672, 160, kernel_size=1,
                      stride=1, padding=0, bias=False),
            nn.BatchNorm2d(160),
            SeModule(160),
        ...
        self.conv3 = nn.Conv2d(960, 640, kernel_size=1,
                               stride=1, padding=0, bias=False)
...
class merge(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1312, 128, 1)
